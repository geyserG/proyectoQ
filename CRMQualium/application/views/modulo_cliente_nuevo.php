...
<div class="contenedor_modulo"> 
    ...
    <section class="contenedor_principal_modulos">
        ...
        <div id="col_info_basica_1" class="input_info">
            ...
            <!-- Este es el pequeño formulario para registrar teléfonos -->
              <div class="btn-group btn-group-justified">
                  <div class="btn-group">
                    <form>
                      <input type="text" id="telefonoCliente" class="telefonoCliente" mane="telefonoCliente" value="1010101010">
                      </form>
                  </div>
                  <div class="btn-group">
                      <select id="tipoTelefonoCliente" class="form-control">
        ...
        <div id='contenedor_menus'>
              ...
              <ul>
                  <li><a><span>Tarjeta de presentación frente</span>
                    <div id='check_posicion'><input type='checkbox' class="serviciosInteres" id='' value='1'></div></a></li>
                  <li><a><span>Medallón</span>
                    <div id='check_posicion'><input type='checkbox' class="serviciosInteres" id='' value='2'></div></a></li>
                  <li><a><span>Tríptico</span>
                    <div id='check_posicion'><input type='checkbox' class="serviciosInteres" id='' value='3'></div></a></li>
                  <li><a><span>Díptico</span>
                    <div id='check_posicion'><input type='checkbox' class="serviciosInteres" id='' value='4'></div></a></li>
                  <li><a><span>Catálogo</span>
                    <div id='check_posicion'><input type='checkbox' class="serviciosInteres" id='' value='5'></div></a></li>
                  <li><a><span>Tarjeta de presentación frente y vuelta</span>
                    <div id='check_posicion'><input type='checkbox' class="serviciosInteres" id='' value='6'></div></a></li>
                  <li><a><span>Anuncio sencillo</span>
                    <div id='check_posicion'><input type='checkbox' class="serviciosInteres" id='' value='7'></div></a></li>
                  <li><a><span>Menú de restaurante</span>
                    <div id='check_posicion'><input type='checkbox' class="serviciosInteres" id='' value='8'></div></a></li>
                  <li><a><span>Branding completo</span>
                    <div id='check_posicion'><input type='checkbox' class="serviciosInteres" id='' value='9'></div></a></li>
                  <li><a><span>Logo animado</span>
                    <div id='check_posicion'><input type='checkbox' class="serviciosInteres" id='' value='10'></div></a></li>
                  <li><a><span>Vídeo branding</span>
                    <div id='check_posicion'><input type='checkbox' class="serviciosInteres" id='' value='11'></div></a></li>
                  <li><a><span>Campaña</span>
                    <div id='check_posicion'><input type='checkbox' class="serviciosInteres" id='' value='12'></div></a></li>
                  <li><a><span>Aplicaciones de campaña</span>
                    <div id='check_posicion'><input type='checkbox' class="serviciosInteres" id='' value='13'></div></a></li>
              </ul>
                  </li>
                  ...
                  <div class='cssmenu'>
                    ...
                    <ul>
                      ...
                      <ul>
                         <li><a ><span>Tarjeta de presentación frente</span>
                         <div id='check_posicion'><input type='checkbox' class="serviciosCuenta" id='' value='1'></div></a></li>
                         <li><a><span>Medallón</span>
                         <div id='check_posicion'><input type='checkbox' class="serviciosCuenta" id='' value='1'></div></a></li>
                         <li><a><span>Tríptico</span>
                         <div id='check_posicion'><input type='checkbox' class="serviciosCuenta" id='' value='1'></div></a></li>
        ...
        <div>
            ...
            <textarea id="textAreaComentario" class="form-control" rows="6" placeholder="Comentarios"></textarea>
        </div>
        ...
        <div class="dato_contacto">
            ...
            <input type="text" id="contactoTelefono" class="form-control" placeholder="Telefono" value="939393939">
        </div>
